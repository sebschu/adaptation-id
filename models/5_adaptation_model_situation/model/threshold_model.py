...
class ThresholdModel:
  ...
  def log_speaker_dist(self, utt_costs=[], expr_idx1=-1, expr_idx2=-1, rat_alpha=1.0, theta_alphas=[], theta_betas=[], utt_other_prob=0.05, noise_strength=0.05):
  ...
  def load_data(self):
    if not os.path.exists(self.config["data_path"]):
      print(f"WARNING: Data file at {self.config['data_path']} does not exist!") 
      return None
