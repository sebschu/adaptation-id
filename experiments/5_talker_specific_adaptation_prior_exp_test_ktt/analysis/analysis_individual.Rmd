...
trials = remove_quotes(format_data(read.csv("../data/5_talker_specific_adaptation_prior_exp_test_ktt-trials.csv")))
exp_trials = remove_quotes(read.csv("../data/5_talker_specific_adaptation_prior_exp_test_ktt-exp_trials.csv"))

conditions = read.csv("../data/5_talker_specific_adaptation_prior_exp_test_ktt-condition.csv")

#subj_info = read.csv("../data/5_talker_specific_adaptation_prior_exp_test_ktt-subject_information.csv") %>% select(workerid)#, noticed_manipulation)
...
print(paste("Excluded", length(exclude), "of", length(unique(trials$workerid)), "participants based on catch-trial performance."))
...
d_likelihoods.cautious = read.csv("~/Dropbox/Uni/RA/adaptation/adaptation/models/4_individual_differences/results/id-05_prior_exp_post_ktt-cautious.likelihood")
  
d_likelihoods.confident = read.csv("~/Dropbox/Uni/RA/adaptation/adaptation/models/4_individual_differences/results/id-05_prior_exp_post_ktt-confident.likelihood")
...
write.csv(d.post_test, "../data/adaptation_data-merged.csv")
...
```{r paper_plots, echo=FALSE}

included_participants = read.csv("../data/A_included_participants.csv")$x
