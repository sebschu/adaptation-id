...
d_likelihoods.cautious = read.csv("~/Dropbox/Uni/RA/adaptation/adaptation/models/4_individual_differences/results/id-03_prior_exp_post_id-cautious.likelihood")
  
d_likelihoods.confident = read.csv("~/Dropbox/Uni/RA/adaptation/adaptation/models/4_individual_differences/results/id-03_prior_exp_post_id-confident.likelihood")
